...
export const ARTICLES: Article[] = [
  ...
  {
    id: 'a-cooks-seafood',
    addedAt: '2026-06-02T14:00:00Z',
    source: 'SFGate',
    sourceUrl: 'https://www.sfgate.com/food/article/cooks-seafood-menlo-park-22283056.php',
    publishedAgo: '1 天前',
    topic: '社区 · 老字号',
    headline: '开了 98 年的 Cook’s Seafood:一份炸鱼薯条占了全店三分之一销量',
    dek: 'Menlo Park 的老牌海鲜市场 · El Camino 上的平价经典',
    emoji: '🐟',
    cover: 'linear-gradient(135deg,#136a8a,#267871)',
    comments: 88,
    reactions: 402,
    intent: '去 Menlo Park 的 Cook’s Seafood 吃份招牌炸鱼薯条',
    tags: ['老字号', '海鲜', '本地小店'],
    body: [
      'Menlo Park 的 Cook’s Seafood 开了快一个世纪 —— 98 年来,它一直是 El Camino Real 上那家又卖鲜鱼、又能坐下吃饭的老牌海鲜市场。',
      'SFGate 写道,这里最出圈的是炸鱼薯条:**一份炸鱼薯条就占了全店三分之一的销量**,几十年如一日地平价、管饱。',
      '没有网红装修,也不靠摆盘 —— 来的人冲的就是那口酥脆,和一家撑过三代人的本地味道。',
    ],
    pois: [
      {
        id: 'cooks-seafood',
        ...
        emoji: '🐟',
        status: 'open',
        blurb: '98 年的老牌海鲜市场 · 招牌炸鱼薯条占全店三分之一销量。',
        neighborhood: 'Menlo Park',
        distance: '4 mi',
        rating: 3.9,
        reviews: 727,
        price: '$$',
        image: 'https://s3-media0.fl.yelpcdn.com/bphoto/3aDxqK8kxireACg8bFTpeA/o.jpg',
        cover: 'linear-gradient(135deg,#136a8a,#267871)',
        via: 'Yelp',
        yelpUrl: 'https://www.yelp.com/biz/cook-s-seafood-menlo-park',
      },
    ],
  },
  {
...
export const DISCOVER: DiscoverCard[] = [
  ...
  },
  {
    ...
    kind: 'find',
    badge: '🔍 本地小众新发现',
    title: 'Taza Deli & Cafe',
    category: '熟食 · 意式冰淇淋',
    emoji: '🥪',
    cover: 'linear-gradient(135deg,#e6b980,#eacda3)',
    image: 'https://s3-media0.fl.yelpcdn.com/bphoto/iOzFE6GTJFw_2ITkca9v0Q/o.jpg',
    neighborhood: 'Broadway, Redwood City',
    distance: '7 mi',
    rating: 4.8,
    reviews: 246,
    price: '$',
    blurb: 'Redwood City 的平价熟食店 · 三明治配一勺手作意式冰淇淋。',
    intent: '中午去 Redwood City 的 Taza 买份三明治',
    tags: ['熟食', '本地小店', '小众'],
    yelpUrl: 'https://www.yelp.com/biz/taza-deli-and-cafe-redwood-city',
  },
  {
    type: 'discover',
    id: 'd-haven',
    ...
    neighborhood: 'Menalto Ave, Menlo Park',
    distance: '3 mi',
    rating: 4.8,
    reviews: 34,
    blurb: 'Menlo Park 街角小酒馆 · 小份餐配酒,白天还能来顿早午餐。',
    intent: '约人去 Menlo Park 的 Haven 喝一杯吃小食',
    tags: ['早午餐', '小酒馆', '小众'],
  ...
  },
  {
    ...
    image: 'https://s3-media0.fl.yelpcdn.com/bphoto/ahYd1FIo5dJhYWOK1F-orw/o.jpg',
    neighborhood: 'Main St, Los Altos',
    distance: '6 mi',
    rating: 4.5,
    reviews: 11,
    blurb: '刚落 Los Altos Main St 的熟成鱼小店 · 主打慢工熟成的江户前。',
    intent: '找个晚上去 Los Altos 的 Haru 尝熟成鱼',
    tags: ['日料', '寿司', '新店', '小众'],
    yelpUrl: 'https://www.yelp.com/biz/haru-los-altos',
  },
  {
    type: 'discover',
    id: 'd-tt-supermarket',
    ...
    category: '亚洲超市 · 美食广场',
    emoji: '🛒',
    cover: 'linear-gradient(135deg,#e52d27,#b31217)',
    image: 'https://s3-media0.fl.yelpcdn.com/bphoto/93qS68BQyO5z2Pgltc0hKw/o.jpg',
    neighborhood: 'Saratoga Ave, San Jose',
    distance: '13 mi',
    blurb: '加拿大最大亚洲超市本月首店落圣何塞 · 一站逛遍亚洲味。',
    intent: '等 T&T 开业去囤一趟亚洲食材',
    tags: ['新店', '亚洲超市', '美食'],
    yelpUrl: 'https://www.yelp.com/biz/t-and-t-supermarket-san-jose-2',
  },
  {
    type: 'discover',
    id: 'd-cibeles',
    ...
    kind: 'find',
    badge: '🆕 家门口新开',
    title: 'Cibele’s Ice Cream',
    category: '冰淇淋 · 咖啡',
    emoji: '🍦',
    cover: 'linear-gradient(135deg,#ff5f6d,#ffc371)',
    neighborhood: 'Willow Rd, Menlo Park',
    distance: '3 mi',
    rating: 4.6,
    reviews: 50,
    blurb: '101 路口新开的冰淇淋咖啡馆 · 一整柜口味挑花眼。',
    intent: '天热了去 Cibele’s 挖一勺冰淇淋',
    tags: ['新店', '冰淇淋', '咖啡', '甜'],
    googleUrl: 'https://maps.google.com/?cid=3889390907084590582',
  },
  {
    type: 'discover',
    id: 'd-sunnyvale-heritage',
    ...
    image: 'https://s3-media0.fl.yelpcdn.com/bphoto/86xDxWOg8bGYRvGAyAT6Xg/o.jpg',
    neighborhood: 'Sunnyvale',
    distance: '7 mi',
    rating: 4.7,
    reviews: 20,
    blurb: '复刻百年果园镇风貌 · 免费,半小时车程的安静一上午。',
    intent: '周末带家人去 Sunnyvale Heritage Park Museum 逛逛',
    tags: ['博物馆', '亲子', '小众'],
    yelpUrl: 'https://www.yelp.com/biz/sunnyvale-heritage-park-museum-sunnyvale',
    googleUrl: 'https://maps.google.com/?cid=3840656612678481219',
  },
  {
    type: 'discover',
    id: 'd-hibari',
